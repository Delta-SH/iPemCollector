...
namespace iPem.Data {
    public partial class H_IDeviceRepository {
        ...
        public void SaveEntities(List<H_IDevice> entities, DateTime curDate) {
            ...
            using(var conn = new SqlConnection(this._databaseConnectionString)) {
                ...
                try {
                    SqlHelper.ExecuteNonQuery(trans, CommandType.Text, string.Format(SqlCommands_Cs.Sql_H_IDevice_Repository_DeleteEntities, curDate.ToString("yyyyMM")), null);
                    foreach(var entity in entities) {
                        ...
                        parms[4].Value = SqlTypeConverter.DBNullStringChecker(entity.StationId);
                        SqlHelper.ExecuteNonQuery(trans, CommandType.Text, string.Format(SqlCommands_Cs.Sql_H_IDevice_Repository_SaveEntities, curDate.ToString("yyyyMM")), parms);
                    }
                    trans.Commit();
                } catch {
                    trans.Rollback();
